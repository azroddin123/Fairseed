...
class CustomAuthentication:
    ...
    def __call__(self, request):
        ...
        print()
        print("--------------------------------------------->")
        if request.path.startswith("/admin/") or request.path.endswith("nt/") or request.path.startswith("/media") or request.path.startswith("/campaign/") or request.path.startswith("/phonepay/"):
