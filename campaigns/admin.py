...
class CampaignAdmin(admin.ModelAdmin):
    list_display = ('catagory','user','rasing_for','title','goal_amount','fund_raised','location','zakat_eligible','status','start_date','end_date','description','summary','is_successfull','is_featured','is_reported')
