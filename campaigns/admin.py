...
class CampaignAdmin(admin.ModelAdmin):
    list_display = ('title','goal_amount','fund_raised','location','zakat_eligible','status','start_date','end_date','description','summary','is_successful','is_featured','is_reported','category','user','rasing_for',)
