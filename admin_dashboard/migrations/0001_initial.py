    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('logo', models.ImageField(blank=True, null=True, upload_to='static/media_files/landing_page/')),
                ('logo_footer', models.ImageField(blank=True, null=True, upload_to='static/media_files/landing_page/')),
                ('favicon', models.ImageField(blank=True, null=True, upload_to='static/media_files/landing_page/')),
                ('image_header', models.ImageField(blank=True, null=True, upload_to='static/media_files/landing_page/')),
                ('image_bottom', models.ImageField(blank=True, null=True, upload_to='static/media_files/landing_page/')),
                ('avtar', models.ImageField(blank=True, null=True, upload_to='static/media_files/landing_page/')),
                ('image_category', models.ImageField(blank=True, null=True, upload_to='static/media_files/landing_page/')),
