# Generated by Django 5.0.8 on 2024-08-13 10:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('campaigns', '0006_alter_campaign_c_id'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Approved', 'Approved'), ('Rejected', 'Rejected')], default='Pending', max_length=124)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateField(auto_now_add=True)),
                ('updated_on', models.DateField(auto_now=True)),
                ('withdrawal_status', models.CharField(choices=[('No_Request', 'No_Request'), ('Paid', 'Paid'), ('Pending', 'Pending'), ('Rejected', 'Rejected')], default='Pending', max_length=124)),
